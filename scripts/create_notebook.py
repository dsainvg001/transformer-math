 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    subprocess.run([\"git\", \"clone\", \"https://github.com/dsainvg001/transformer-math.git\"], check=True)\n",
    "    if os.path.exists(\"transformer-math\"):\n",
    "        os.chdir(\"transformer-math\")\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    }\n",
    "else:\n",
    "    print(\"=== RUNNING IN PRODUCTION MODE (Kaggle T4*2 Multi-GPU Training ~25.25M Params T4-Optimized) ===\")\n",
    "    config = {\n",
    "        \"seed\": 42,\n",
    "        \"precision\": \"bfloat16\",\n",
    "        \"model\": {\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    def plot(self):\n",
    "        try:\n",
    "            # clear_output(wait=True) # Commented out to preserve output logs\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "target_accuracy = config[\"training\"].get(\"target_accuracy\", 0.999)  # Target accuracy threshold (99.9%)\n",
    "\n",
    ...
    "        # plotter.plot() # Commented out to prevent clear_output in Kaggle logs\n",
    "        \n",
    "        if cur_enabled:\n",
    ...
    "            \n",
    "        print(f\"Step {step}/{total_steps} | Val Loss: {val_loss:.4f} | Exact Match: {exact_match*100:.2f}% | Tolerant Acc: {tolerant_acc*100:.2f}%\", flush=True)\n",
    "        \n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Cell 7: Independent Final Testing & Data Corruption Audit\n",
...
with open("r:/ML/math-transformers/train.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=1)

print("train.ipynb successfully created!")
