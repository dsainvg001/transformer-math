 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "        }\n",
    "        replicated_state, loss, grads_norm = parallel_step(\n",
    "            replicated_state,\n",
    ...
    "    else:\n",
    "        state, loss, grads_norm = train_step(model, state, batch[\"input_ids\"], batch[\"loss_mask\"])\n",
    "        loss_val = float(loss)\n",
    "        \n",
    "    if cur_enabled:\n",
    "        cur_tracker.update_train_losses(batch[\"category_idx\"], loss_val)\n",
    "        if step % cur_cfg.get(\"update_interval\", 250) == 0:\n",
    "            cur_tracker.recompute_probabilities()\n",
    "            \n",
...
with open("r:/ML/math-transformers/train_tpu.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=1)

print("train_tpu.ipynb successfully created!")
