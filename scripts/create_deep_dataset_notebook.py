...
notebook = {
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Cell 3: Multi-Phase Dataset Generation Settings (3,500 Shards Total - Rate Limit Protected)\n",
    ...
    "UPLOAD_INTERVAL = 300  # Upload batch every 5 minutes to prevent HF rate limits\n",
    ...
    "print(f\"- Upload Batch Interval: {UPLOAD_INTERVAL}s (5 mins)\")\n",
    "print(f\"- Remote Auto-Resume: Enabled\")\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        \"--upload-interval\", str(UPLOAD_INTERVAL),\n",
    "        \"--auto-resume\",\n",
